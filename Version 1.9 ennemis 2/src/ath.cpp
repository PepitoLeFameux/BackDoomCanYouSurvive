...
void Ath::Init(int largeurEcran, int hauteurEcran, Arme *arme, int *pvJoueur, int *shieldJoueur, int *nbKill, std::unordered_map<std::string, bool> *effects){
...
void Ath::Render(){
    ...
    DrawTexturePro(weapons[arme->numeroArme], (Rectangle){0, 0, weapons[arme->numeroArme].width, weapons[arme->numeroArme].height},
                   (Rectangle){300 - taille*(float)weapons[arme->numeroArme].width/2.0f, 2100 - taille*(float)weapons[arme->numeroArme].width/2.0f, (float)weapons[arme->numeroArme].width*taille, (float)weapons[arme->numeroArme].height*taille},
                   (Vector2){150, 1050}, 0.0f, WHITE);
